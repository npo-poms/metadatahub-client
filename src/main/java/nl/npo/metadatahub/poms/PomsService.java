 ...
 */
@Log
public class PomsService implements MediaProvider, AutoCloseable {
    ...
    public PomsService(MetadatahubClient client) {
        this.client = client;
    ...
    private static String readQueryTemplate(String fileName) {
        try (var in = Objects.requireNonNull(
            PomsService.class.getResourceAsStream("/sparql/" + fileName),
